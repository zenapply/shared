...
$factory->define(Zenapply\Shared\Models\Video::class, function (Faker\Generator $faker) {
    return [
        'video_url' => $faker->url,
        'video_service' => $faker->randomElement(['youtube', 'vimeo', 'viddler']),
        'video_id' => $faker->bothify('#?#?#?'),
    ];
});
